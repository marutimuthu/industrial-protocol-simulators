...
def publishDeviceBirth():
    ...
    addMetric(payload, "DateTime Metric", None, MetricDataType.Float, time.time())
...
client = mqtt.Client()  # or just mqtt.Client() with no args
client.connect(serverUrl, 1883, 60)  # host, port, keepalive
